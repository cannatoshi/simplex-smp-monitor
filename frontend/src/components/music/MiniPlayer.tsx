            ...
            <div className="relative w-full max-w-2xl rounded-2xl overflow-hidden" style={{ backgroundColor: 'rgb(15, 23, 42)', border: `1px solid ${neonBlue}`, boxShadow: `${neonGlow}, 0 25px 50px rgba(0,0,0,0.5)` }} onClick={(e) => e.stopPropagation()}>
              ...
              <div className="p-6 grid grid-cols-2 gap-6 max-h-[70vh] overflow-y-auto">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-3 rounded-lg bg-slate-800/30"><span className="text-sm text-slate-300">Format</span><select value={cacheSettings?.preferred_format || 'mp3'} onChange={(e) => handleUpdateSettings({ preferred_format: e.target.value })} className="px-3 py-1.5 text-sm rounded-lg bg-slate-800 border border-slate-700" style={{ color: neonBlue }}><option value="mp3">MP3</option><option value="m4a">M4A</option><option value="opus">OPUS</option></select></div>
                  ...
                  <div className="pt-4 border-t border-slate-800"><a href="/forensics" className="w-full py-3 rounded-lg text-sm font-medium flex items-center justify-center gap-2" style={neonButtonStyle} onClick={() => setShowCachePanel(false)}><svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" /></svg>View Database</a></div>
                </div>
              </div>
            </div>
          </div>,
