...
3. Fill in the details:
   ...
   - **Type:** SMP (Messaging) or XFTP (File Transfer)
   - **Address:** Full server URL (e.g., `smp://fingerprint:password@host.onion`)
...
- **From Add/Edit page:** Click "Test Connection" button
- **Automatic:** Tests run on demand, results are saved
- **Tor routing:** `.onion` addresses automatically use SOCKS5 proxy
- **Latency:** Displayed in milliseconds after successful test
